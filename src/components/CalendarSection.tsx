          ...
          <Card className="bg-peach-gradient border-none shadow-xl">
            ...
            <CardContent>
              <Calendar
                ...
                className="rounded-md border-none shadow-inner bg-white/50"
                modifiers={{
            ...
            <CardContent>
              {selectedEntry ? (
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="secondary" className="bg-accent/30 text-primary">
                      {selectedEntry.mood}
                    </Badge>
                  </div>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-primary/60">No journal entry for this date</p>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-primary/60">Click on a date to view your journal entry</p>
                </div>
              )}
            </CardContent>
          </Card>
